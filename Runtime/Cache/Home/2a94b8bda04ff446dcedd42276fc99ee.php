...
<!-- Header start -->
				...
				<div class="row">
					...
					<div class="collapse navbar-collapse clearfix navMenu" role="navigation">
						<ul class="nav navbar-nav navbar-right">
				            ...
				            <li><a class="page-scroll" href="#process" >使用指导</a></li>
    ...
    <!-- END MAIN NAV -->
     ...
     <!-- slider section -->
    <section class="slider" id="slider-top">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="copyright">
								<p class="pull-right">Copyright &copy; 2015.Company name All rights reserved.<a target="_blank" href="http://sc.chinaz.com/moban/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></p>
							</div>
						</div>
					</div>
				</div>
